...
export default function NavBar() {
  ...
  return (
    <div className="fixed bottom-0 left-0 z-50 flex justify-around items-center w-full h-[65px] border-t-2 border-[#14213D] rounded-t-[10px] bg-white shadow-md lg:hidden">
      <div
